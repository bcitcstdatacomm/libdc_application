...
typedef void (*dc_setting_set_func)(const struct dc_posix_env *env, struct dc_error *err, struct dc_setting *setting, const void *value, dc_setting_type type);
...
struct options
{
    ...
    int val;
    const char *env_key;
    const void *(*read_from_string)(const struct dc_posix_env *env, struct dc_error *err, const char *str);
    const char *config_key;
    const void *(*read_from_config)(const struct dc_posix_env *env, struct dc_error *err, config_setting_t *item);
...
const void *dc_string_from_string(const struct dc_posix_env *env, struct dc_error *err, const char *str);
const void *dc_flag_from_string(const struct dc_posix_env *env, struct dc_error *err, const char *str);
